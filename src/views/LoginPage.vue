...
<template>
  <div
    class="w-full h-screen flex md:flex-row flex-col md:justify-center md:items-center items-start justify-center bg-blue-200 md:px-0 px-2"
  >
    <div class="w-auto md:w-1/2 md:self-auto">
      <svg
        class="mx-auto h-10 md:h-80 w-auto"
        viewBox="0 0 24 24"
        aria-hidden="true"
      >
        <g>
    ...
    <div class="md:w-1/2 w-full">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm sm:px-10">
        <h2
          class="mt-10 md:text-center text-2xl font-bold leading-9 tracking-tight text-gray-900"
        >
