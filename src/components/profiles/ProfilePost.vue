<template>
  <transition appear name="fade">
    <div class="w-400 xs:w-450 md:w-450 xl:w-600 overflow-hidden">
      <div class="px-4 pt-2 pb-1">
        <h1 class="font-bold text-xl text-black">Let's get you set up</h1>
      </div>
      <!-- slide -->
      <div class="w-400 xs:w-450 md:w-450 xl:w-600">
        <div
        ...
        >
          <!-- Carousel wrapper -->
          <div class="relative h-44 overflow-hidden rounded-lg md:h-44 w-400 xs:w-450 md:w-450 xl:w-600">
            <!-- Item 1 -->
            <div
...
export default {
  props: ["tweet"],
  components: { PostView, FollowPost, LoadingPage },
  setup() {
