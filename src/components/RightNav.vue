  ...
  <div class="hidden md:block w-290 lg:w-350 h-screen">
    ...
    >
      ...
      <div class="relative m-2">
        <div
            class="absolute text-black flex items-center pl-4 h-full cursor-pointer"
        >
          <svg
        ...
        <input
            class="w-full  dark:bg-dim-100 border-gray-200 dark:border-dim-600 text-black focus:bg-gray-100 dark:focus:bg-dim-900 focus:outline-none focus:border focus:border-blue-200 font-normal h-9 flex items-center pl-12 text-sm rounded-full border shadow"
      ...
      <footer>
        <ul class="text-xs text-gray-500 my-4 mx-2">
          ...
          <li class="inline-block mx-2">© {{date}} Twitter, Inc.</li>
        </ul>
      </footer>
    </div>
  </div>
